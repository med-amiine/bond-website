...
export default function Testimonials() {
  ...
  return (
    <section ref={sectionRef} className="relative py-32 overflow-hidden" style={{ position: 'relative', zIndex: 1 }}>
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#84CC86]/5 rounded-full blur-[150px]" />
        ...
        <div ref={cardRef} className="relative">
          <div className="card-dark p-8 sm:p-12 relative overflow-hidden" data-cursor-default>
            ...
            <div className="absolute top-8 right-8 opacity-10">
              <svg width="80" height="80" fill="currentColor" viewBox="0 0 24 24" className="text-[#84CC86]">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#84CC86] to-[#A3D9A5] flex items-center justify-center">
