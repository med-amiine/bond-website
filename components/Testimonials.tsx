        ...
        <div ref={cardRef} className="relative">
          <div className="card-dark p-8 sm:p-12 relative overflow-hidden" data-cursor-default>
            ...
            <div className="absolute top-8 right-8 opacity-10">
              <svg width="80" height="80" fill="currentColor" viewBox="0 0 24 24" className="text-[#22D3EE]">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#22D3EE] to-[#67E8F9] flex items-center justify-center">
