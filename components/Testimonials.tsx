...
export default function Testimonials() {
  ...
  return (
    <section ref={sectionRef} className="relative py-32 overflow-hidden" style={{ position: 'relative', zIndex: 1 }}>
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#27279E]/5 rounded-full blur-[150px]" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={titleRef} className="text-center mb-16">
          ...
          <p className="text-lg text-[var(--text-sub)]">See what our customers have to say about SnapChain.</p>
        </div>
        ...
        <div ref={cardRef} className="relative">
          <div className="card-dark p-8 sm:p-12 relative overflow-hidden" data-cursor-default>
            ...
            <div className="absolute top-8 right-8 opacity-10">
              <svg width="80" height="80" fill="currentColor" viewBox="0 0 24 24" className="text-[#27279E]">
            ...
            <div className="relative z-10">
              <p className="text-xl sm:text-2xl text-[var(--text)] leading-relaxed mb-8">
                &ldquo;{t.quote}&rdquo;
              </p>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#27279E] to-[#3B3BB8] flex items-center justify-center">
                  <span className="text-[#050505] font-bold text-sm">{t.avatar}</span>
                </div>
                <div>
                  <div className="text-[var(--text)] font-semibold">{t.author}</div>
