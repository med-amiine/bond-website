          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-2 w-full sm:w-auto">
              <input
                ...
                className="flex-1 sm:w-64 px-4 py-3 rounded-full bg-[#0a0a0a] border border-[#27272a] text-white text-sm placeholder:text-[#71717a] focus:outline-none focus:border-[#22D3EE] transition-colors duration-300"
              />
