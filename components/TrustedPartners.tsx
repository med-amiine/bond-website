              ...
              {partners.map((p, i) => (
                <div key={i} className="partner-logo group">
                  <div className="text-center">
                    <div className="w-12 h-12 mx-auto rounded-xl bg-[#1a1a1a] flex items-center justify-center mb-2 group-hover:bg-[#84CC86]/10 group-hover:shadow-[0_0_20px_rgba(132,204,134,0.4)] group-hover:ring-1 group-hover:ring-[#84CC86]/30 transition-all duration-300">
                      <span className="text-lg font-bold text-[#71717a] group-hover:text-[#84CC86] transition-colors duration-300">{p.abbr}</span>
                    </div>
            ...
            <div className="space-y-4 mb-8">
              {bullets.map((b, i) => (
                <div key={i} className="flex items-center gap-3">
                  <div className="w-5 h-5 rounded-full bg-[#84CC86]/20 flex items-center justify-center flex-shrink-0">
                    <svg className="w-3 h-3 text-[#84CC86]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
