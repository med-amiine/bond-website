  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundColor: isHovering ? 'transparent' : '#84CC86',
          border: isHovering ? '2px solid #050505' : 'none',
          boxShadow: isHovering 
            ? '0 0 30px rgba(132, 204, 134, 0.6), 0 0 60px rgba(132, 204, 134, 0.3), inset 0 0 20px rgba(132, 204, 134, 0.2)'
            : '0 0 20px rgba(132, 204, 134, 0.8), 0 0 40px rgba(132, 204, 134, 0.4)',
      ...
      <div
        ...
        style={{
          ...
          background: 'radial-gradient(circle, rgba(132, 204, 134, 0.15) 0%, transparent 70%)',
          filter: 'blur(4px)',
      ...
      <div
        ...
        style={{
          width: 100,
          height: 100,
          background: 'radial-gradient(circle, rgba(132, 204, 134, 0.1) 0%, transparent 60%)',
          filter: 'blur(8px)',
        }}
      />
    </>
