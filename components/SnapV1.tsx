    ...
    >
      <div className="min-h-screen flex items-center px-6 lg:px-24 max-w-[1400px] mx-auto py-20">
        ...
        <div ref={titleRef} className="w-full lg:w-1/2 pr-0 lg:pr-16 z-10">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#22D3EE]/30 bg-[#22D3EE]/10 text-[#22D3EE] text-sm font-medium mb-6 backdrop-blur-sm">
          ...
          <h2 className="text-4xl lg:text-6xl font-bold text-white mb-6 leading-[1.1] tracking-tight">
            Everything you need to <span className="text-[#22D3EE]">build</span>
          </h2>
              ...
              return (
                ...
                >
                  <div>
                    ...
                    {/* Title */}
                    <h3 className="text-[#22D3EE] font-semibold text-xl mb-1">{feature.title}</h3>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <svg width="120" height="24" viewBox="0 0 120 24" fill="none" aria-label={`Block ${String(currentCard + 1).padStart(2, '0')} of 04`}>
                ...
                <line x1="12" y1="12" x2="36" y2="12" strokeWidth="2" 
                  stroke={currentCard >= 1 ? 'rgba(34, 211, 238, 0.3)' : '#27272a'} 
                  className="transition-all duration-500"/>
                <line x1="44" y1="12" x2="68" y2="12" strokeWidth="2" 
                  stroke={currentCard >= 2 ? 'rgba(34, 211, 238, 0.3)' : '#27272a'} 
                  className="transition-all duration-500"/>
                <line x1="76" y1="12" x2="100" y2="12" strokeWidth="2" 
                  stroke={currentCard >= 3 ? 'rgba(34, 211, 238, 0.3)' : '#27272a'} 
                  className="transition-all duration-500"/>
                
                {/* Node 1 */}
                <circle cx="12" cy="12" r="6" 
                  fill={currentCard >= 0 ? '#22D3EE' : '#27272a'} 
                  stroke={currentCard >= 0 ? '#22D3EE' : '#3f3f46'} 
                  strokeWidth="1.5"
                  className="transition-all duration-500"/>
                {currentCard === 0 && (
                  <circle cx="12" cy="12" r="12" fill="none" stroke="rgba(34, 211, 238, 0.4)" strokeWidth="1" opacity="0.6">
                ...
                <circle cx="40" cy="12" r="6" 
                  fill={currentCard >= 1 ? '#22D3EE' : '#27272a'} 
                  stroke={currentCard >= 1 ? '#22D3EE' : '#3f3f46'} 
                  strokeWidth="1.5"
                  className="transition-all duration-500"/>
                {currentCard === 1 && (
                  <circle cx="40" cy="12" r="12" fill="none" stroke="rgba(34, 211, 238, 0.4)" strokeWidth="1" opacity="0.6">
                    <animate attributeName="r" values="6;12" dur="2s" repeatCount="indefinite"/>
                    <animate attributeName="opacity" values="0.6;0" dur="2s" repeatCount="indefinite"/>
                  </circle>
                )}
                ...
                <circle cx="68" cy="12" r="6" 
                  fill={currentCard >= 2 ? '#22D3EE' : '#27272a'} 
                  stroke={currentCard >= 2 ? '#22D3EE' : '#3f3f46'} 
                  strokeWidth="1.5"
                  className="transition-all duration-500"/>
                {currentCard === 2 && (
                  <circle cx="68" cy="12" r="12" fill="none" stroke="rgba(34, 211, 238, 0.4)" strokeWidth="1" opacity="0.6">
                    <animate attributeName="r" values="6;12" dur="2s" repeatCount="indefinite"/>
                    <animate attributeName="opacity" values="0.6;0" dur="2s" repeatCount="indefinite"/>
                  </circle>
                )}
                ...
                <circle cx="96" cy="12" r="6" 
                  fill={currentCard >= 3 ? '#22D3EE' : '#27272a'} 
                  stroke={currentCard >= 3 ? '#22D3EE' : '#3f3f46'} 
                  strokeWidth="1.5"
                  className="transition-all duration-500"/>
                {currentCard === 3 && (
                  <circle cx="96" cy="12" r="12" fill="none" stroke="rgba(34, 211, 238, 0.4)" strokeWidth="1" opacity="0.6">
                    <animate attributeName="r" values="6;12" dur="2s" repeatCount="indefinite"/>
                    <animate attributeName="opacity" values="0.6;0" dur="2s" repeatCount="indefinite"/>
                  </circle>
                )}
              ...
              <div className="text-[11px] tracking-wide font-mono">
                ...
                <span className="text-[#22D3EE] font-semibold">{String(currentCard + 1).padStart(2, '0')}</span>
